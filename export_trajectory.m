function export_trajectory(time,jointStateMsg,data,joint_position)
    ...
    excel_fiel_name=strrep(fullFileName,'.txt','.xls')
    time=time';
     fprintf(fileId,'%s\r\n','----------------------real trajectory--------------------------------');
    fprintf(fileId,'%s\r\n','----------------------------------------------------------------------') ;  
    ...
    xlswrite(excel_fiel_name,teor_excel,'Sheet1','A1')
    xlswrite(excel_fiel_name,real_excel,'Sheet1','A8')
    xlswrite(excel_fiel_name,diff_excel,'Sheet1','A15')
